...
import { LayoutDashboard, Package, ShoppingBag, Tags, Users, ArrowLeft, Ticket, BarChart3, Settings as SettingsIcon, Gift, Activity, Coins, Store, Home, GraduationCap, Bell, Bot, Camera, ShieldCheck, MapPin, Images } from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/visitor-locations", label: "Visitor Locations", icon: MapPin },
  { to: "/admin/permissions", label: "Page Permissions", icon: ShieldCheck },
  { to: "/admin/gallery-permissions", label: "Gallery Permissions", icon: Images },
  ...
  { to: "/admin/home-items", label: "Home Items", icon: Home },
