            ...
            <div className="relative flex flex-1 items-center justify-center py-6">
              ...
              <div className="absolute bottom-2 right-0 max-w-[260px] rounded-lg border border-primary/40 bg-black/80 p-3 font-mono text-xs shadow-[0_0_20px_rgba(34,255,136,0.25)] backdrop-blur">
                <p className="text-primary">
                  $ tunnel <span className="text-foreground">secure</span>
                </p>
                <p className="text-primary/80">
                  $ enc: <span className="text-foreground">AES-256</span>
                </p>
                <p className="text-primary">
                  $ awaiting
          ...
          <div className="w-full max-w-md">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              {tab === "signin"
                ...
                : "Join Wikiservices in seconds — no email verification needed"}
            </p>
            ...
            >
              ...
              <svg className="relative h-5 w-5" viewBox="0 0 48 48" aria-hidden="true">
                <path
                  fill="#FFC107"
                  d="M43.6 20.5H42V20H24v8h11.3C33.8 32.9 29.4 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34 6.1 29.3 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.3-.1-2.4-.4-3.5z"
                />
                <path
                  fill="#FF3D00"
                ...
                <path
                  fill="#4CAF50"
                  d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2c-2 1.5-4.5 2.4-7.2 2.4-5.3 0-9.8-3.1-11.4-7.5l-6.5 5C9.6 39.6 16.2 44 24 44z"
                />
                <path
                  fill="#1976D2"
                  d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4-4 5.4l6.2 5.2C40.7 35.4 44 30.2 44 24c0-1.3-.1-2.4-.4-3.5z"
                />
              </svg>
            ...
            <Tabs value={tab} onValueChange={setTab}>
              ...
              <TabsContent value="signin">
                <form
                  onSubmit={signIn}
                  className="mt-6 space-y-4 rounded-2xl border border-primary/30 bg-card/60 p-6 shadow-[0_0_30px_rgba(34,255,136,0.08)] backdrop-blur"
                >
                  <Field icon={<Mail className="h-4 w-4" />} label="Email">
                    <Input
                      ...
                      className="input-neon pl-10 h-11"
                    />
                  </Field>
    ...
    <div>
      ...
      <div className="field-neon relative mt-1.5">
        <div className="relative rounded-[calc(var(--radius)+1px)] bg-card/70">
          <span className="pointer-events-none absolute left-3 top-1/2 z-10 -translate-y-1/2 text-primary drop-shadow-[0_0_6px_color-mix(in_oklab,var(--primary)_70%,transparent)]">
            {icon}
          </span>
          {children}
        </div>
