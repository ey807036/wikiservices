...
export function Header() {
  ...
  const visibleNav =
    isStore || isOrderHistory ? NAV.filter((n) => n.to === "/store" || n.to === "/my-orders") : NAV;
        ...
        {isStore ? (
          <Link to="/store" className="flex items-center gap-2 font-bold text-xl">
            <img
              src={logo}
              alt="Wiki Store"
              className="h-9 w-9 drop-shadow-[0_0_12px_oklch(0.85_0.27_145/0.5)]"
              width={36}
              height={36}
            />
          ...
          <Link to="/" className="flex items-center gap-1.5 font-bold">
            ...
            <span className="inline-flex sm:hidden items-center gap-1.5 text-[15px] font-black uppercase tracking-tight leading-none text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.55)]">
